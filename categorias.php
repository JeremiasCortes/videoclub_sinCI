...
<div class="contenido bg-light">
  <div class=" table-responsive">
    <a class="btn btn-info mt-5 float-end margen-inferior" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Nueva Categoria <i class="bi bi-window-plus"></i></a>
        ...
        <?php if ($result->num_rows > 0) : ?>
          <?php while ($row = $result->fetch_assoc()) : ?>
            <tr>
              ...
              <td class="modificar" data-id="<?= $row['id']; ?>" data-nom="<?= $row['nom']; ?>">
                <a href="#">
                  <i class="bi bi-pencil-square"></i>
                </a>
              </td>
              <td>
                <a class="eliminar" href="categoriaEliminar.php?id=<?= $row['id']; ?>"><i class="bi-trash3-fill"></i></a>
              </td>
            </tr>
          <?php endwhile; ?>
        <?php else : ?>
  ...
  <form action="categoriaModificar.php" method="post" id="formModificar">
